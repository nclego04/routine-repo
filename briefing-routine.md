...
1. Bump the `Current:` line to the next study day.
   - Days run 1–5 per week (5 study days). After Day 5, advance to the next
     week's Day 1.
   - Phase 0 runs Weeks 0.1 → 0.8 (0.8 is the buffer/consolidation week). After
     Week 0.7 Day 5, advance to `Current: Phase 0, Week 0.8, Day 1`; only after
     Week 0.8 Day 5 advance to the first build week, `Current: Week 3, Day 1`
...
2. Add a one-line `## Log` entry with the matching prefix:
   - Phase 0: `- P<week>D<day>:` (P for the theory phase, e.g. `P1D1:` for Week 0.1
     Day 1, `P7D5:` for Week 0.7 Day 5, `P8D5:` for the Week 0.8 buffer Day 5).
...
- Catch-up weeks — Phase 0's Week 0.8, then build Weeks 7 and 12 — are real buffer. Week 16 is a decision week, not a study week: the plan deliberately stops there pending the MS branch point. If a deliverable
