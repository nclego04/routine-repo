...
**Q:** Find complex β such that e^β = −e⁻¹.<br>
**A:** Write −1 = e^{jπ} (not e^{−j3π/2} — that lands on +j, not −1). So β = −1 + jπ (+ j2πk).

**Q:** In ∑ₘ bᵐ, what is α when matching to the template C∑αⁿ?<br>
...
**Q:** Why does x[n] + y[n] behave differently from x(t) + y(t) for periodicity?<br>
...
**Q:** Reindexing ∫x(t)dt with t = −r — what changes, that doesn't change when reindexing a sum?<br>
